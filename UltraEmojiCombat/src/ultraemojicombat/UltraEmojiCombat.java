...
public class UltraEmojiCombat {
    ...
    public static void main(String[] args) {      
        ...
        //Instância da Classe Luta (Não tem Método Construtor)
        Luta fight = new Luta();        
        
        // Instância da Classe Lutador (6 Lutadores)
        //Lutador(nome, Nacionalidade, Idade, Altura, Peso, Vitorias, Derrotas, Empates)
